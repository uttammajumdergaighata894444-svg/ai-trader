...
class FeatureEngineering:
    ...
    def extract_features(cls, price_history):
        ...
        sma_5 = cls.calculate_sma(
            price_history,
            window=5
        )

        rsi_14 = cls.calculate_rsi(
            price_history,
            window=14
        )
...
class TradingAppLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.voice_btn.bind(
            on_press=self.listen_voice_command
        )
        ...
        self.risk_mgr = RiskManagementSystem(
            max_risk_per_trade_pct=0.01
        )
        ...
        if (
            ...
            if position_size > 0:
                ...
                self.balance_label.text = (
                    "Balance: $"
                    f"{trade_res['closing_balance']:.2f}"
                )
